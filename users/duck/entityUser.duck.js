...
export function getList(id) {
    const request = axios.get(`${process.env.REACT_APP_API_HOST}/entity_users?search=user_id:${id}&with=entity:id,name,entity_type_id;profile:id,noun;entity.entityType:id,name`)
    return {
