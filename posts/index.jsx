...
// import { create as createMenuPostCategory } from './postPostCategory.duck'
...
const mapStateToProps = state => ({
    show: state.post.show,
    isEdit: state.form.postForm && state.form.postForm.initial && state.form.postForm.initial.id > 0
})

const mapDispatchToProps = dispatch => bindActionCreators({
    getList, showContent, update, init, create
    // , createMenuPostCategory
}, dispatch)
