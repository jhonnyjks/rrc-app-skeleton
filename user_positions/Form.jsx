            ...
            <form onSubmit={this.props.handleSubmit(this.onSubmit)}>
                <div className="card card-primary">
                    <div className="card-header">
                        <h3 className="card-title">Novo Cargo</h3>
                    </div>
                    <div className='card-body'>
                        <Row>
                            ...
                            <Field name='description' component={LabelAndInput} readOnly={this.props.readOnly}
                                label='Descrição' cols='12 4' placeholder='Descreva...' error={this.props.errors} />
                        </Row>
                    </div>
...
Form = reduxForm({ form: 'userPositionForm', destroyOnUnmount: false })(Form)
const selector = formValueSelector('userPositionForm')
const mapStateToProps = state => ({
    name: selector(state, 'name'),
    description: selector(state, 'description'),
    errors: state.userPosition.errors
})
